...
The button uses the compiled ARM template at `infra/main.json`. Replace `<OWNER>`/`<REPO>` with your GitHub path or clone locally and follow [docs/DEPLOY_AZURE.md](docs/DEPLOY_AZURE.md) for `azd`-based deployments using `infra/main.bicep`.
