...
const recommendedEnv = ["NEXT_PUBLIC_SITE_URL", "NEXT_PUBLIC_APP_ENV"] as const;

const serverOnlyEnv = ["SUPABASE_SERVICE_ROLE_KEY"] as const;

type EnvKey = typeof requiredEnv[number] | typeof serverOnlyEnv[number] | (typeof recommendedEnv)[number];
